...
class EmbossClient:
	...
	def __parseSequenceInput(self, 
		...
		list = [] # list to hold sequence query strings
	...
	def __parseReply(self, 
		...
		# get fault, report, and outseq elements with xpath queries
	...
	def getSequences(self, 
		...
		Effects:	Nothing
		Throws:		Any error generated by EmbossClient
		"""
